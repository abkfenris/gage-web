...
def get_section(id):
	...
	Example response: ::
		...
		{ "access": null,
		  "description": "Most commonly run from the where Goose Eye Brook joins Bull Branch on down to Twin Bridges, Bull Branch is a gem of Western Maine. It most commonly runs when the Wild River gage in Gilead goes over 4 ft.",
		  "id": 1,
